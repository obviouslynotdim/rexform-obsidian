export interface NoteEntry { id: string; path: string; isMarker?: boolean; mtime?: number; ctime?: number }
export interface FileNode { type: 'file'; name: string; id: string; path: string; mtime?: number; ctime?: number }
