  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "#1a1a2e" }}>
      <div className="w-full max-w-md rounded-2xl border p-8" style={{ background: "#16213e", borderColor: "#2a2a4a" }}>
        ...
        <h1 className="text-2xl font-bold mb-1" style={{ color: "#e0e0e0" }}>Welcome back</h1>
        <p className="text-sm mb-6" style={{ color: "#8892a4" }}>Sign in to your workspace</p>
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "#8892a4" }}>
          ...
          <Link href="/register" className="font-medium hover:underline" style={{ color: "#7F77DD" }}>Create one</Link>
        </p>
      </div>
    </div>
  )
