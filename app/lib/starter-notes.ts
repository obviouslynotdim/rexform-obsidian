...
1. Browse your notes using the **Notes** page in the sidebar
2. Try linking notes with [[wikilinks]]
3. Add tags with #tag to organise your thoughts

> **Your vault is private — only you can see your notes**

---

*Welcome to your REXFORM Notes vault. Start by reading the [[Quick Start Guide]] or jump straight into [[My First Note]].*
`;
